...
/* ------------------------------------------------------------ */
/***	int IOShieldOledClass::defineUserChar(char ch, BYTE *pbDef)
**
**	Parameters:
...
/* ------------------------------------------------------------ */
/***	void IOShieldOledClass::setDrawColor(BYTE clr)
**
**	Parameters:
...
/* ------------------------------------------------------------ */
/***	BYTE* IOShieldOledClass::getStdPattern(int ipat)
**
**	Parameters:
...
/* ------------------------------------------------------------ */
/***	void IOShieldOledClass::setFillPattern(BYTE *pbPat)
**
**	Parameters:
...
/* ------------------------------------------------------------ */
/***	BYTE IOShieldOledClass::getPixel(void)
**
**	Parameters:
**		none
**
...
/* ------------------------------------------------------------ */
/***	void IOShieldOledClass::getBmp(int dxco, int dyco, BYTE *pbBmp)
**
**	Parameters:
...
/* ------------------------------------------------------------ */
/***	void IOShieldOledClass::putBmp(int dxcp, int dyco, BYTE *pbBmp)
**
**	Parameters:
**		dxco		- width of bitmap
**		dyco		- height of bitmap
