...
void setup()
{
  ...
  //Initialize Configuration register for onshot with 11 bit
  //resolution
  IOShieldTemp.config(IOSHIELDTEMP_ONESHOT | IOSHIELDTEMP_RES12 | IOSHIELDTEMP_ALERTHIGH);
  ...
  IOShieldTemp.setTempLimit(IOShieldTemp.convFtoC(75)); // 78.0F ~ 25.5C
